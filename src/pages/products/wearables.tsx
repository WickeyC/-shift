...
const filterWearableProducts = importedProducts.filter((product) => {
  return product.type === 'WEARABLE';
});

const WearableProductsPage = () => {
  const [products, setProducts] = useState(filterWearableProducts);
  ...
  const handleSearchSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (searchTerm.trim() === '') {
      ...
      setSearchResultText('');
      setProducts(filterWearableProducts);
      setSearchTerm('');
    } else {
      ...
      const searchedProducts = filterWearableProducts.filter((product) => {
  ...
  return (
    <>
      <Head>
        <title>Wearables - Shift</title>
      </Head>
      <Header />
      <main>
        <CategoryHeader>
          <div className="container">
            <Title>Explore Wearables</Title>
...
export default WearableProductsPage;
